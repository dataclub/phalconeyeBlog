 ...
 * @BelongsTo("categorie_id", '\Blog\Model\Categorie', "id", {
 *  "alias": "Categorie"
 * })
 * @BelongsTo("parent_id", '\Blog\Model\CategorieItem', "id", {
 *  "alias": "CategorieItem"
 * })
 * @HasMany("id", "\Blog\Model\CategorieItem", "parent_id", {
 *  "alias": "CategorieItem"
 * })
 *
 * @method static \Blog\Model\CategorieItem findFirst($parameters = null)
 */
class CategorieItem extends AbstractModel
{
    use Sortable;
    ...
    {
        return $this->getRelated('Categorie', $arguments);
    }

    /**
     * Return the related "Categorie" entity.
     *
     * @param array $arguments Entity params.
     *
     * @return Categorie
     ...
     *
     * @return CategorieItem|Categorie
     */
    public function getParent()
    {
        if ($this->parent_id) {
            ...
            return Categorie::findFirst($this->categorie_id);
        }
    }
