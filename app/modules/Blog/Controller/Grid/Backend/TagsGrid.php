 ...
 */
class TagsGrid extends BackendBlogGrid
{
    /**
    ...
    {
        return [
            'Edit' => ['href' => ['for' => 'admin-module-blog-tags-edit', 'id' => $item['id']]],
            'Delete' => [
                'href' =>
                    [
                        'for' => 'admin-module-blog-tags-delete', 'id' => $item['id']
                    ],
