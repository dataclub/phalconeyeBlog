 ...
 */
class BlogRecentPostsGrid extends FrontendBlogGrid
{
    private $layoutView = 'partials/grid/frontend/blog_recent_posts/layout';
    private $itemView = 'partials/grid/frontend/blog_recent_posts/item';
    private $bodyView = 'partials/grid/frontend/blog_recent_posts/body';
