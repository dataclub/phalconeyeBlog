 ...
 */
class BlogArchivesGrid extends FrontendBlogGrid
{
    private $layoutView = 'partials/grid/frontend/blog_archives/layout';
    private $itemView = 'partials/grid/frontend/blog_archives/item';
    private $bodyView = 'partials/grid/frontend/blog_archives/body';
